  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: Obx(() => AppBar(
          backgroundColor: themeController.isDarkMode.value ? AppColors.darkBackground : AppColors.primary,
          actions: [
            Obx(() => Switch(
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return InkWell(
              ...
              child: Obx(() => Card(
                color: themeController.isDarkMode.value ? AppColors.darkBackground : AppColors.lightBackground,
                elevation: 4,
                ...
                child: ListTile(
                  ...
                  title: Text(
                    ...
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: themeController.isDarkMode.value ? AppColors.lightBackground : AppColors.lightText,
                    ),
                  ),
                  subtitle: Text(
                    user.email,
                    style: TextStyle(
                      fontSize: 14,
                      color: themeController.isDarkMode.value ? AppColors.darkText : AppColors.lightText,
                    ),
                  ),
                ),
              )),
